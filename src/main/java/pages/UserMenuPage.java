...
public boolean isDeveloperConsoleVisible() 
{
	return DevelopersConsole.isDisplayed();
}
public static void closeDeveloperConsole(WebDriver driver) {

    WebElement closeButton = driver.findElement(By.cssSelector(".x-tab-strip-close"));
    
    closeButton.click();
}
	public boolean clickLogout(WebDriver driver, String sOption) 
	{
		boolean isOptionSelected = false;
		if (userMenu.isDisplayed()) {
			userMenu.click();
