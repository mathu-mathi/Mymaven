...
public class TestCase15 extends TestCase5
{
	//WebDriver driver=new ChromeDriver();
	public void SalesforceOpportunitiesTest()
	{
		WebDriver driver=new ChromeDriver();
		Wait<WebDriver> w = new WebDriverWait(driver, Duration.ofSeconds(2));
{
...
public static void main(String[] args)
{
	//WebDriver driver=new ChromeDriver();
	 ...
	 try {
   	 ...
   	 obj.SalesforceOpportunitiesTest();
	obj.userMenuAndMyProfile();
   	 obj.Account(); 
